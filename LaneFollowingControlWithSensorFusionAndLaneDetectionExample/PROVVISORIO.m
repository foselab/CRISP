...
Results_Table_by_APDISC_SECONDA_PARTE = table('Size', sz, 'VariableTypes',varTypes, 'VariableNames',varNames);
...
for i = 79 : numero_iterazioni
    ...
    Results_Table_by_APDISC_SECONDA_PARTE(i,:)={Scenario_file_name, Vehicle_file_name, fitness_simulation, Collision, discontinuityMaxValue};
...
total_fault_col = NaN(height(Results_Table_by_APDISC_SECONDA_PARTE), 1);
total_fault_col(1) = numero_casi_fail_trovati;
Results_Table_by_APDISC_SECONDA_PARTE.Total_Fault_Found = total_fault_col;

%% SALVATAGGIO DATI 

writetable(Results_Table_by_APDISC_SECONDA_PARTE, 'tabellarisultati_APDISC_CONF2_SECONDA_PARTE.xlsx');
