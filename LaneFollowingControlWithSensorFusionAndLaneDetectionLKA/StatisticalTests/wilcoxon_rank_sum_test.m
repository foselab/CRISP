...
T5 = readtable('tabellarisultatiHecate_LKA_CONF1_APDISC.xlsx');
vettore_fitness_APDISC = double(T5{1:end, 3}); % estraggo la colonna delle collisioni escludendo la prima riga di intestazione
...
T_fitness = readtable('tabellarisultatiHecate_LKA_CONF1_HECATE.xlsx');
...
position_vector_RANDOM_TOTAL = [position_vector_RANDOM_1 position_vector_RANDOM_2 position_vector_RANDOM_3 position_vector_RANDOM_4 position_vector_APDISC];

[p,h,stats] = ranksum(position_vector_HECATE,position_vector_RANDOM_TOTAL)
