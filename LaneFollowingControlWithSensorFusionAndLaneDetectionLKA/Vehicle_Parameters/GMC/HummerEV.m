...
max_acceleration = 6.97;         % Maximum acceleration                           (m/s^2)   Quella reale è 8.97
min_acceleration = -5.00;        % Minimum acceleration                           (m/s^2)
max_steering = 0.36;             % Maximum steering                               (rad)
min_steering = -0.36;            % Minimum steering                               (rad)  