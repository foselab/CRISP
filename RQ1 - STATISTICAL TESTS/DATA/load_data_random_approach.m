...
vettore_failure_medio_ACC_CONF1_RAND = zeros(1,length(vettore_failure_binario_1));
...
for j=1:length(vettore_failure_binario_1)
    summa = vettore_failure_binario_1(j)+vettore_failure_binario_2(j)+vettore_failure_binario_3(j)+vettore_failure_binario_4(j)+vettore_failure_binario_5(j);
...
vettore_failure_medio_ACC_CONF2_RAND = zeros(1,length(vettore_failure_binario_1));
...
vettore_failure_medio_LKA_CONF1_RAND = zeros(1,length(vettore_failure_binario_1));
...
vettore_failure_medio_LKA_CONF2_RAND = zeros(1,length(vettore_failure_binario_1));
...
vettore_failure_medio_LKA_CONF3_RAND = zeros(1,length(vettore_failure_binario_1));
