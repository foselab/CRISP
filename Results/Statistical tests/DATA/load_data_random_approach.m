...
failure_vector_medio_ACC_CONF1_RAND = zeros(1,length(binary_failure_vector_1));
...
for j=1:length(binary_failure_vector_1)
    ...
    failure_vector_medio_ACC_CONF1_RAND(j)=valore_medio; 
end
...
failure_vector_medio_ACC_CONF2_RAND = zeros(1,length(binary_failure_vector_1));
...
for j=1:length(binary_failure_vector_1)
    summa = binary_failure_vector_1(j)+binary_failure_vector_2(j)+binary_failure_vector_3(j)+binary_failure_vector_4(j)+binary_failure_vector_5(j);
    valore_medio = summa/5; 
    failure_vector_medio_ACC_CONF2_RAND(j)=valore_medio; 
end
...
failure_vector_medio_LKA_CONF1_RAND = zeros(1,length(binary_failure_vector_1));
...
for j=1:length(binary_failure_vector_1)
    summa = binary_failure_vector_1(j)+binary_failure_vector_2(j)+binary_failure_vector_3(j)+binary_failure_vector_4(j)+binary_failure_vector_5(j);
    valore_medio = summa/5; 
    failure_vector_medio_LKA_CONF1_RAND(j)=valore_medio; 
end
...
failure_vector_medio_LKA_CONF2_RAND = zeros(1,length(binary_failure_vector_1));
...
for j=1:length(binary_failure_vector_1)
    summa = binary_failure_vector_1(j)+binary_failure_vector_2(j)+binary_failure_vector_3(j)+binary_failure_vector_4(j)+binary_failure_vector_5(j);
    valore_medio = summa/5; 
    failure_vector_medio_LKA_CONF2_RAND(j)=valore_medio; 
end
...
failure_vector_medio_LKA_CONF3_RAND = zeros(1,length(binary_failure_vector_1));
...
for j=1:length(binary_failure_vector_1)
    summa = binary_failure_vector_1(j)+binary_failure_vector_2(j)+binary_failure_vector_3(j)+binary_failure_vector_4(j)+binary_failure_vector_5(j);
    valore_medio = summa/5; 
    failure_vector_medio_LKA_CONF3_RAND(j)=valore_medio; 
end
